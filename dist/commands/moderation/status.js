...
module.exports = {
    ...
    callback: function (_a) {
        var interaction = _a.interaction, args = _a.args, client = _a.client;
        return __awaiter(this, void 0, void 0, function () {
            var type, name, url;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        type = args[0], name = args[1], url = args[2];
                        return [4 /*yield*/, interaction.reply({ content: i18n.__('moderation.status.start'), ephemeral: true })];
                    case 1:
                        _b.sent();
                        client.user.setActivity({ name: name, type: type, url: url });
