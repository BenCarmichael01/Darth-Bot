...
exports.MUSIC_CHANNEL_ID = config ? config.MUSIC_CHANNEL_ID : process.env.MUSIC_CHANNEL_ID;
exports.playingMessageId = config ? config.playingMessageId : process.env.playingMessageId;