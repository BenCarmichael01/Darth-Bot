        ...
        collector.on("collect", (reaction, user) => {
            ...
            switch (reaction.emoji.name) {
                case "⏭":
                    ...
                    queue.textChannel.send(`<@{author}> ⏩ skipped the song`, { author: user }).catch(console.error);
                    collector.stop();
                    break;
                ...
                case "⏯":
                    ...
                    if (queue.playing) {
                        ...
                        queue.textChannel.send(`<@{ author }> ⏸ paused the music.`, { author: user }).catch(console.error);
                    } else {
                        queue.playing = !queue.playing;
